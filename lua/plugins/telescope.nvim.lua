return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>gd", builtin.lsp_definitions, { desc = "Telescope lsp implementations" })
		vim.keymap.set("n", "<leader>gy", builtin.lsp_type_definitions, { desc = "Telescope lsp type implementations" })
